...
class PcaPathCells(Step):
    ...
    def run(
        self,
        pca_csv_loc=Path("/allen/aics/assay-dev/MicroscopyOtherData/Viana/forCaleb/variance/05202020_Align-IND_Chirality-OFF/manifest.csv"),
        pcs=[1,2,3,4,5,6,7,8],
        ...
        **kwargs
        ...
        pc_path_dir = (self.step_local_staging_dir / "pc_paths").mkdir(parents=True, exist_ok=True)
        ...
        for pc in pcs:
            ...
            self.manifest = self.manifest.append({"PC":pc, "dataframe_path":df_loc})
